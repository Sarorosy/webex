...
const ManageUsers = ({ onClose }) => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch(
        "https://webexback-vb1k.onrender.com/api/users/fetchallusers"
      );
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await fetch(
        `https://webexback-vb1k.onrender.com/api/users/delete/${selectedUser}`,
        {
          method: "DELETE",
        }
      );
  ...
  const updateUserType = async (userId, newType, permissionsData = null) => {
    try {
      ...
      const response = await fetch(
        `https://webexback-vb1k.onrender.com/api/users/changeUserType`,
        {
          method: "PUT",
          headers: {
