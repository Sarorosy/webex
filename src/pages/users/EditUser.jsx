...
const EditUser = ({ userId, onClose, after }) => {
    ...
    useEffect(() => {
        const fetchUserDetails = async () => {
            try {
                setFetching(true);
                const response = await fetch(`https://webexback-vb1k.onrender.com/api/users/user/${userId}`);
                ...
                if (data.status) {
                    ...
                    setUserData({
                        ...
                        profilePic: data.user.profile_pic ? `https://rapidcollaborate.in/ccp${data.user.profile_pic}` : null
                    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://webexback-vb1k.onrender.com/api/users/update`, formData, {
