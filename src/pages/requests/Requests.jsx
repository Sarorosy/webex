...
const Requests = ({ onClose }) => {
  ...
  const fetchUserRequests = async () => {
    try {
      const res = await axios.get("https://webexback.onrender.com/api/userlimit/all");
  ...
  const fetchGroupRequests = async () => {
    try {
      const res = await axios.get("https://webexback.onrender.com/api/grouplimit/all");
      if (res.data.status) {
  ...
  const handleUserApprove = async (id) => {
    try {
      const res = await axios.post(
        "https://webexback.onrender.com/api/userlimit/approve",
        { id }
      );
  ...
  const handleGroupApprove = async (id) => {
    ...
    try {
      const res = await axios.post(
        "https://webexback.onrender.com/api/grouplimit/approve",
        { id, member_limit }
      );
